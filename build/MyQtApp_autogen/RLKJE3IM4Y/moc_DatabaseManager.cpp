...
QT_MOC_LITERAL(5, 56, 5) // "error"
    ...
    "DatabaseManager\0connected\0\0disconnected\0"
    "connectionError\0error"
};
...
void DatabaseManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DatabaseManager::connected)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (DatabaseManager::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DatabaseManager::disconnected)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DatabaseManager::connectionError)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void DatabaseManager::connected()
{
